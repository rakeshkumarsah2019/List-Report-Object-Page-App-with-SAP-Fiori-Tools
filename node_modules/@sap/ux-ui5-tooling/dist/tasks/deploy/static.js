...
/**
 * Generate an index.html that can be used for running applications standalone
 * @param component component name
 */
function generateIndexHtml(component) {
    return Buffer.from(`
<!DOCTYPE HTML>
<html>
...
<head>
	...
	<script type="text/javascript">
		window["sap-ushell-config"] = {
			...
			applications: {
				"app-preview": {
					title: "Page Builder",
					description: "This is my new Fiori elements application",
	...
	<script src="https://ui5.sap.com/test-resources/sap/ushell/bootstrap/sandbox.js"
