 ...
 * @param entityTypeFQN
 */
function parseProperties(entityProperties, entityKeys, entityTypeFQN) {
...
function parseNavigationProperties(navigationProperties, currentEntityType, entityTypeFQN) {
...
function parseEntityTypes(entityTypes, namespace) {
    return entityTypes.reduce((outArray, entityType) => {
        ...
        const { entityProperties, entityKeys } = parseProperties(utils_1.ensureArray(entityType.Property), entityKeyNames, entityTypeFQN);
        const navigationProperties = parseNavigationProperties(utils_1.ensureArray(entityType.NavigationProperty), entityType, entityTypeFQN);
        outArray.push({
            _type: "EntityType",
