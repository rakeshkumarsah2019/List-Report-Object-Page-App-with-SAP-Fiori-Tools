/**
 * Source:https://github.com/sap-staging/ui5-flexibility-utils/blob/origin/master/src/changeUtils.js [2020-06-03]
 */
...
function createString(propertyBag) {
    return JSON.stringify({
        ...
        selector: {
            ...
            idIsLocal: false, // LOCAL FIX, NOT IN ORIGINAL, was set to true but this doesn't work for Fiori apps
            type: propertyBag.controlType // LOCAL FIX, NOT IN ORIGINAL, control type can't be set. Should we use content?
        },
