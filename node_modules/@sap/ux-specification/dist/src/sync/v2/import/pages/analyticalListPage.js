...
function addSettings(analyticalListPageConfig, manifest, jsonSchema, pageKey) {
    ...
    index_1.transferSettingsOfObject(analyticalListPageConfig.filterBar, manifest, jsonSchema['definitions']['FilterBar'], pageKey);
...
function createAnalyticalListPageConfig(manifest, flex, jsonSchema) {
    ...
    for (const pageKey in v2Pages) {
        ...
        if (utils_1.getPageType(v2Page.component.name) === page_1.PageType.AnalyticalListPage) {
