 ...
 * @param appSchema {object} - application specific JSON schema
 * @param entitySet {string} - entity Set
 * @param pages {SapUiAppPageV4[]} - list of (manifest) pages
 * @param entityTypes {EntityType[]} - list of entity types and associated annotations (AVT)
 */
...
function generateObjectPageSchemaV4(genericSchema, entitySet, entityTypes, manifest) {
    ...
    // Add sections
    addSections(appSchema, entitySet, manifest['sap.ui5'].routing.targets, entityTypes);
    // Custom Section facets
    addRelatedFacetKeysType(appSchema, entitySet, manifest['sap.ui5'].routing.targets, entityTypes);
    return appSchema;
}
